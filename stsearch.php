...
<table width="100%" border="0" cellspacing="01" cellpadding="01">
  ...
  <tr>
    ...
    <th width="6%" scope="col">&nbsp;</th>
          ...
          <div style="background-color: beige; margin-left: 33%; text-align: center; width: 35%">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td align="right"><font size="5">Student ID&nbsp;:&nbsp;</font></td>
    <td><input id="in" type="text" name="sid" value="<?php if($row) echo $row['s_id'];?>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"><font size="5">Name&nbsp;:&nbsp;</font></td>
    <td><input id="in" type="text" name="stname" value="<?php if($row) echo $row['name'];?>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"><font size="5">Email&nbsp;:&nbsp;</font></td>
    <td><input id="in" type="email" name="stemail" value="<?php if($row) echo $row['email'];?>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"><font size="5">Phone&nbsp;:&nbsp;</font></td>
    <td><input id="in" type="text" name="stphone" value="<?php if($row) echo $row['phone'];?>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"><font size="5">Password &nbsp;:&nbsp;</font></td>
    <td><input id="in" type="password" name="stpass" value="<?php if($row) echo $row['password'];?>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"><font size="5">Year&nbsp;:&nbsp;</font></td>
    <td><input  id="in" type="text" name="styear" value="<?php if($row) echo $row['year'];?>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    ...
    <td><select name="stream" style="width: 13em; height: 2em; font-size: 15px; ">
         ...
         <option value="CSE" <?php if($row) if($row['stream']=='CSE') echo 'selected="selected"'; ?>>CSE</option>
        <option value="COM" <?php if($row) if($row['stream']=='COM') echo 'selected="selected"'; ?>>COM</option>
        <option value="EE" <?php if($row) if($row['stream']=='EE') echo 'selected="selected"'; ?>>EE</option>          
        </select></td>
    <td>&nbsp;</td>
  </tr>
